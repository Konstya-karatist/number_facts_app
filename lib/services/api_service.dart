...
class ApiService {
  ...
  static const String _apiBaseUrl = String.fromEnvironment(
    ...
    defaultValue: 'https://number-facts-api-yk2u.onrender.com/api/number',
  );
  ...
  Future<NumberFact> fetchNumberFact(int number) async {
    try {
      final response = await _client
          .get(Uri.parse('$_apiBaseUrl/$number'))
      ...
      throw Exception('Ошибка сети. Проверьте подключение к Render API.');
    } on TimeoutException {
